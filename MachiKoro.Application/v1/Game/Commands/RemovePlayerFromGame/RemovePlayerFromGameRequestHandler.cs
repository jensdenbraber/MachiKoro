...
{
    public class RemovePlayerFromGameRequestHandler : IRequestHandler<RemovePlayerFromGameRequest, RemovePlayerFromGameResponse>
    {
        private readonly IGamesRepository _gameRepository;

        public RemovePlayerFromGameRequestHandler(IGamesRepository gameRepository)
        {
